...
# mainwindow.py | Python | 1310L | 87 symbols | 14 imports | 64 comments
...
- fn `def _setupTrimSettingsControls(self)` `priv` (L274-284)
  ...
  - Return: {None} Applies UI side effects.
- fn `def _setupTrimPresetControls(self)` `priv` (L285-315)
...
### fn `def _setupTrimPresetAction(self)` `priv` (L316-333)
...
### fn `def _trimPresetEditableFlag(self)` `priv` (L334-338)

### fn `def _trimPresetRole(self)` `priv` (L339-343)

### fn `def _defaultTrimPresetName(self)` `priv` (L344-351)
...
### fn `def _toBool(self, value)` `priv` (L352-362)
...
### fn `def _updateTrimPagesRangeControls(self, enabled)` `priv` (L363-373)
...
### fn `def _parseTrimPagesRange(self)` `priv` (L374-390)
...
### fn `def _collectRuntimeConfigValues(self)` `priv` (L391-406)
...
### fn `def _preserveFieldsEnabled(self)` `priv` (L407-420)
...
### fn `def _trimPresetFromCurrentSelection(self)` `priv` (L421-440)
...
### fn `def _refreshTrimPresetList(self)` `priv` (L441-469)
...
### fn `def _persistTrimPresetDocument(self)` `priv` (L470-487)
...
### fn `def _applyCropPreset(self, crop_values)` `priv` (L488-519)
...
### fn `def _applyTrimPreset(self, index)` `priv` (L520-545)
...
### fn `def slotTrimPresetClicked(self, item, column)` (L546-558)
...
### fn `def slotTrimPresetDoubleClicked(self, item, column)` (L559-569)
...
### fn `def slotTrimPresetChanged(self, item, column)` (L570-593)
...
### fn `def slotDeleteTrimPreset(self)` (L594-612)
...
### fn `def slotSaveMarginsPreset(self)` (L613-624)
...
### fn `def selectedConversionMode(self)` (L625-632)
...
### fn `def currentSelectionUpdated(self)` (L633-648)

### fn `def readSettings(self)` (L649-697)
...
### fn `def writeSettings(self)` (L698-722)
...
### fn `def openFile(self, fileName)` (L723-742)

### fn `def slotOpenFile(self)` (L743-748)

### fn `def slotSelectFile(self)` (L749-758)

### fn `def showWarning(self, title, text)` (L759-766)

### fn `def str2pages(self, s)` (L767-784)

### fn `def primarySelectionCropValue(self, page_indexes)` (L785-798)
...
### fn `def buildGhostscriptCropPlan(self, inputFileName, outputFileName, requestedPageIndexes=None)` (L799-834)
...
### fn `def createConversionProgressDialog(self, totalPages)` (L835-857)
...
### fn `def slotPdfFrame(self)` (L858-980)
...
### fn `def mark_page_processed(page_number)` (L912-930)
- Brief: Executes PDF crop action using Ghostscript command backend.
...
### fn `def on_output_line(line)` (L931-945)
...
### fn `def slotZoomIn(self)` (L981-984)

### fn `def slotZoomOut(self)` (L985-988)

### fn `def slotFitInView(self, checked)` (L989-993)

### fn `def slotSplitterMoved(self, pos, idx)` (L994-996)

### fn `def slotPreviousPage(self)` (L997-1000)

### fn `def slotNextPage(self)` (L1001-1004)

### fn `def slotFirstPage(self)` (L1005-1008)

### fn `def slotLastPage(self)` (L1009-1012)

### fn `def slotCurrentPageEdited(self, text)` (L1013-1020)

### fn `def updateControls(self)` (L1021-1029)

### fn `def slotSelectionMode(self, checked)` (L1030-1033)

### fn `def slotSelExceptionsChanged(self)` (L1034-1036)

### fn `def slotSelExceptionsEdited(self, text)` (L1037-1041)

### fn `def slotSelAspectRatioChanged(self)` (L1042-1050)

### fn `def slotSelAspectRatioTypeChanged(self, index)` (L1051-1070)

### fn `def distributeAspectRatioChanged(self, aspectRatio)` (L1071-1073)

### fn `def slotDistributeAspectRatioChanged(self)` (L1074-1076)

### fn `def slotDeviceTypeChanged(self, index)` (L1077-1083)

### fn `def slotContextMenu(self, pos)` (L1084-1104)

### fn `def slotDeleteSelection(self)` (L1105-1108)

### fn `def slotNewSelection(self)` (L1109-1111)

### fn `def slotNewSelectionGrid(self)` (L1112-1121)

### fn `def createSelectionGrid(self, grid)` (L1122-1155)

### fn `def getPadding(self)` (L1156-1183)
...
### fn `def slotTrimMarginsAll(self)` (L1184-1196)

### fn `def slotTrimMargins(self)` (L1197-1201)

### fn `def trimMarginsSelection(self, sel)` (L1202-1305)
...
### fn `def resizeEvent(self, event)` (L1306-1308)

### fn `def closeEvent(self, event)` (L1309-1310)
...
|`MainWindow._setupTrimPresetControls`|fn|priv|285-315|def _setupTrimPresetControls(self)|
|`_setupTrimPresetAction`|fn|priv|316-333|def _setupTrimPresetAction(self)|
|`_trimPresetEditableFlag`|fn|priv|334-338|def _trimPresetEditableFlag(self)|
|`_trimPresetRole`|fn|priv|339-343|def _trimPresetRole(self)|
|`_defaultTrimPresetName`|fn|priv|344-351|def _defaultTrimPresetName(self)|
|`_toBool`|fn|priv|352-362|def _toBool(self, value)|
|`_updateTrimPagesRangeControls`|fn|priv|363-373|def _updateTrimPagesRangeControls(self, enabled)|
|`_parseTrimPagesRange`|fn|priv|374-390|def _parseTrimPagesRange(self)|
|`_collectRuntimeConfigValues`|fn|priv|391-406|def _collectRuntimeConfigValues(self)|
|`_preserveFieldsEnabled`|fn|priv|407-420|def _preserveFieldsEnabled(self)|
|`_trimPresetFromCurrentSelection`|fn|priv|421-440|def _trimPresetFromCurrentSelection(self)|
|`_refreshTrimPresetList`|fn|priv|441-469|def _refreshTrimPresetList(self)|
|`_persistTrimPresetDocument`|fn|priv|470-487|def _persistTrimPresetDocument(self)|
|`_applyCropPreset`|fn|priv|488-519|def _applyCropPreset(self, crop_values)|
|`_applyTrimPreset`|fn|priv|520-545|def _applyTrimPreset(self, index)|
|`slotTrimPresetClicked`|fn|pub|546-558|def slotTrimPresetClicked(self, item, column)|
|`slotTrimPresetDoubleClicked`|fn|pub|559-569|def slotTrimPresetDoubleClicked(self, item, column)|
|`slotTrimPresetChanged`|fn|pub|570-593|def slotTrimPresetChanged(self, item, column)|
|`slotDeleteTrimPreset`|fn|pub|594-612|def slotDeleteTrimPreset(self)|
|`slotSaveMarginsPreset`|fn|pub|613-624|def slotSaveMarginsPreset(self)|
|`selectedConversionMode`|fn|pub|625-632|def selectedConversionMode(self)|
|`currentSelectionUpdated`|fn|pub|633-648|def currentSelectionUpdated(self)|
|`readSettings`|fn|pub|649-697|def readSettings(self)|
|`writeSettings`|fn|pub|698-722|def writeSettings(self)|
|`openFile`|fn|pub|723-742|def openFile(self, fileName)|
|`slotOpenFile`|fn|pub|743-748|def slotOpenFile(self)|
|`slotSelectFile`|fn|pub|749-758|def slotSelectFile(self)|
|`showWarning`|fn|pub|759-766|def showWarning(self, title, text)|
|`str2pages`|fn|pub|767-784|def str2pages(self, s)|
|`primarySelectionCropValue`|fn|pub|785-798|def primarySelectionCropValue(self, page_indexes)|
|`buildGhostscriptCropPlan`|fn|pub|799-834|def buildGhostscriptCropPlan(self, inputFileName, outputF...|
|`createConversionProgressDialog`|fn|pub|835-857|def createConversionProgressDialog(self, totalPages)|
|`slotPdfFrame`|fn|pub|858-980|def slotPdfFrame(self)|
|`mark_page_processed`|fn|pub|912-930|def mark_page_processed(page_number)|
|`on_output_line`|fn|pub|931-945|def on_output_line(line)|
|`slotZoomIn`|fn|pub|981-984|def slotZoomIn(self)|
|`slotZoomOut`|fn|pub|985-988|def slotZoomOut(self)|
|`slotFitInView`|fn|pub|989-993|def slotFitInView(self, checked)|
|`slotSplitterMoved`|fn|pub|994-996|def slotSplitterMoved(self, pos, idx)|
|`slotPreviousPage`|fn|pub|997-1000|def slotPreviousPage(self)|
|`slotNextPage`|fn|pub|1001-1004|def slotNextPage(self)|
|`slotFirstPage`|fn|pub|1005-1008|def slotFirstPage(self)|
|`slotLastPage`|fn|pub|1009-1012|def slotLastPage(self)|
|`slotCurrentPageEdited`|fn|pub|1013-1020|def slotCurrentPageEdited(self, text)|
|`updateControls`|fn|pub|1021-1029|def updateControls(self)|
|`slotSelectionMode`|fn|pub|1030-1033|def slotSelectionMode(self, checked)|
|`slotSelExceptionsChanged`|fn|pub|1034-1036|def slotSelExceptionsChanged(self)|
|`slotSelExceptionsEdited`|fn|pub|1037-1041|def slotSelExceptionsEdited(self, text)|
|`slotSelAspectRatioChanged`|fn|pub|1042-1050|def slotSelAspectRatioChanged(self)|
|`slotSelAspectRatioTypeChanged`|fn|pub|1051-1070|def slotSelAspectRatioTypeChanged(self, index)|
|`distributeAspectRatioChanged`|fn|pub|1071-1073|def distributeAspectRatioChanged(self, aspectRatio)|
|`slotDistributeAspectRatioChanged`|fn|pub|1074-1076|def slotDistributeAspectRatioChanged(self)|
|`slotDeviceTypeChanged`|fn|pub|1077-1083|def slotDeviceTypeChanged(self, index)|
|`slotContextMenu`|fn|pub|1084-1104|def slotContextMenu(self, pos)|
|`slotDeleteSelection`|fn|pub|1105-1108|def slotDeleteSelection(self)|
|`slotNewSelection`|fn|pub|1109-1111|def slotNewSelection(self)|
|`slotNewSelectionGrid`|fn|pub|1112-1121|def slotNewSelectionGrid(self)|
|`createSelectionGrid`|fn|pub|1122-1155|def createSelectionGrid(self, grid)|
|`getPadding`|fn|pub|1156-1183|def getPadding(self)|
|`slotTrimMarginsAll`|fn|pub|1184-1196|def slotTrimMarginsAll(self)|
|`slotTrimMargins`|fn|pub|1197-1201|def slotTrimMargins(self)|
|`trimMarginsSelection`|fn|pub|1202-1305|def trimMarginsSelection(self, sel)|
|`resizeEvent`|fn|pub|1306-1308|def resizeEvent(self, event)|
|`closeEvent`|fn|pub|1309-1310|def closeEvent(self, event)|
